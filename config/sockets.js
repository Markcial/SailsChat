...
module.exports.sockets = {
  ...
  onDisconnect: function(session, socket) {
    ...
    //ChatEventManager.onDisconnect(session, socket);
    /*var io = sails.io;
    console.log('disconnected');
    console.log('socketID',socket.id);
    console.log('roomClients',io.sockets.manager.roomClients);
    console.log('roomClient',io.sockets.manager.roomClients[socket.id]);
    console.log('socketRooms',socket.manager.rooms);
    console.log('socketRoom',socket.manager.roomClients[socket.id]);
    console.log('rooms',socket.manager.roomClients);
    */
